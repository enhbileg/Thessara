...
const Cart = () => {
  const { products, router, cartItems, addToCart, updateCartQuantity, getCartCount, language } = useAppContext();
              ...
              <thead className="text-left">
                <tr>
                  <th className="pb-4 md:pb-6 md:px-4 px-1 text-[11px] md:text-sm text-gray-600 font-medium">
                    {dict.productDetails || "Product Details"}
                  </th>
                  <th className="pb-4 md:pb-6 md:px-4 px-1 text-[11px] md:text-sm text-gray-600 font-medium">
                    {dict.price || "Price"}
                  </th>
